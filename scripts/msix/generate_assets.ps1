...
# (resources\images\InlongSlicer_gradient_circle.svg). Each PNG is rendered from
...
$source   = Join-Path $repoRoot 'resources\images\InlongSlicer_gradient_circle.svg'
...
$renderScript = Join-Path $env:TEMP 'inlong_msix_render.py'
