#!/usr/bin/env bash
#
# Build InlongSlicer Flatpak locally using Docker with the same container image
...
echo "=== InlongSlicer Flatpak Build ==="
...
# ---------- prepare manifest ----------
MANIFEST_SRC="scripts/flatpak/io.github.JaredLin1217.InlongSlicer.yml"
MANIFEST_DOCKER="scripts/flatpak/io.github.JaredLin1217.InlongSlicer.docker.yml"
...
flatpak-builder $FORCE_CLEAN_FLAG \
    ...
    --repo=flatpak-repo \
    flatpak-build \
    scripts/flatpak/io.github.JaredLin1217.InlongSlicer.docker.yml
builder_end=$(date +%s)
