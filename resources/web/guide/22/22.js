...
function SortUI()
{
	...
	for(let n=0;n<nMode;n++)
	{
		...
		/* INLONG use label tag to allow checkbox to toggle when user ckicked to text */
...
{
	// INLONG add ability to only select / unselect filted items
...
function GotoNetPluginPage()
{
	...
	if(bRet)
		window.location.href="../4inlong/index.html";
}
