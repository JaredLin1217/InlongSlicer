...
Deep comparison of two `.3mf` files (InlongSlicer, OrcaSlicer, BambuStudio, or any compatible slicer).
...
⚠️ CRITICAL DISCREPANCY: Huge difference in part weight:
  InlongSlicer 60.90 g vs BambuStudio 17.47 g (difference 43.43 g or 71.3%).
...
2. **BBS compatibility verification** — compare InlongSlicer output against BambuStudio
