...
// scripts/inlong_id_tool.py). The C++ generate_preset_setting_id() MUST stay byte-identical
...
//   python3 -c "import sys; sys.path.insert(0, 'scripts'); from inlong_id_tool import generate_preset_setting_id as g; print(g('Afinia','filament','Afinia ABS @Afinia H400'))"
