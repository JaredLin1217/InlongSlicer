...
InlongSlicer uses **Catch2 v3** (currently v3.11.0, vendored in `tests/catch2/`) as its primary testing framework. The test suite is organized into several modules that mirror the project's architectural components:
...
```cpp
// InlongSlicer is on Catch2 v3.11.0 - all of these ARE available:
// SKIP() macro                           - v3.3.0+
