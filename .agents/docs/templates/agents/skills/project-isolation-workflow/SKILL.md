...
- Runtime cleanup/hiring/scoring: expand `.agents/docs/agents/workflows.yaml`; dispatch closeout runs `runtime.quiet_cleanup` for current parent/cwd closed subagent ids; no backups.
