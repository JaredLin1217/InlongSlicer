...
- Put portable Codex App environment guidance in `.codex/environments/environment.template.toml`.
- Put live autogenerated Codex App environment state in local `.codex/environments/environment.toml`; do not deploy this live file to other projects.
- Put other Codex App project settings in `.codex/`.
