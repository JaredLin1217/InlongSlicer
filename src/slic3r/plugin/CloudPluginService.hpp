...
{
public:
    void set_cloud_agent(std::shared_ptr<InlongCloudServiceAgent> agent);
    std::shared_ptr<InlongCloudServiceAgent> get_cloud_agent() const;
...
private:
    std::shared_ptr<InlongCloudServiceAgent> m_orca_agent = nullptr;
};
