                                                                              ...
                                                                              std::string&       error)
{
    ...
    // C++ interface used by the rest of InlongSlicer.
...
void bind_python_api(pybind11::module_& m)
{
    ...
    m.def(
        ...
        R"pbdoc(Register a PluginCapability subclass while InlongSlicer loads your module.)pbdoc");
    ...
    m.def(
        ...
        R"pbdoc(Request filesystem read permissions while InlongSlicer loads your module.
