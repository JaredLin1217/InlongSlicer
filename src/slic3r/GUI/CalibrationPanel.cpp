...
void CalibrationPanel::init_tabpanel() {
    ...
    m_tabpanel->SetBackgroundColour(wxColour("#FEFFFF")); // INLONG match sidebar background color
    ...
    // INLONG use standard paddings and keep arrow icon for consistent look between sidebars
    //for (int i = 0; i < (int)CALI_MODE_COUNT; i++)
