    ...
    , state_handler(this)
{
    ...
    border_color.append(wxColour(185, 87, 58), StateColor::Pressed);
    border_color.append(wxColour(225, 130, 99), StateColor::Hovered);
    border_color.append(0xD66C47, StateColor::Normal);
    ...
    background_color.append(wxColour(185, 87, 58), StateColor::Pressed);
    background_color.append(wxColour(225, 130, 99), StateColor::Hovered);
    background_color.append(0xD66C47, StateColor::Normal);
