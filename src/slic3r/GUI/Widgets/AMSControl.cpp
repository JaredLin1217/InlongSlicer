...
void AMSControl::msw_rescale()
{
    ...
    if (m_button_extruder_feed) m_button_extruder_feed->Rescale(); // INLONG
    if (m_button_extruder_back) m_button_extruder_back->Rescale(); // INLONG
    if (m_button_auto_refill) m_button_auto_refill->Rescale();     // INLONG
