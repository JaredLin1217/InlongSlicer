    ...
    : paddingSize(10, 8)
{
    background_color = StateColor(
        ...
        std::make_pair(0xD66C47, (int) StateColor::Checked),
...
wxString btn_regular[10]  = {"#DFDFDF", "#DFDFDF", "#D4D4D4", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#262E30", "#D66C47", "#D66C47"};
wxString btn_confirm[10]  = {"#DFDFDF", "#D66C47", "#E18263", "#D66C47", "#D66C47", "#6B6A6A", "#FEFEFE", "#FEFEFE", "#E99678", "#FFC2AD"};
wxString btn_alert[10]    = {"#DFDFDF", "#DFDFDF", "#E14747", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#FFFFFD", "#D66C47", "#D66C47"};
