...
public:
    enum VisibleButtons { // INLONG VisibleButtons instead ButtonStyle
        ONLY_CONFIRM        = 0,
    ...
    SecondaryCheckDialog(
        ...
        enum VisibleButtons btn_style = CONFIRM_AND_CANCEL, // INLONG VisibleButtons instead ButtonStyle
    ...
    void update_title_style(wxString title, SecondaryCheckDialog::VisibleButtons style, wxWindow* parent = nullptr); // INLONG VisibleButtons instead ButtonStyle
    ...
    VisibleButtons m_button_style; // INLONG VisibleButtons instead ButtonStyle
...
public:
    ...
    HyperLink* m_trouble_shoot{ nullptr }; // INLONG
