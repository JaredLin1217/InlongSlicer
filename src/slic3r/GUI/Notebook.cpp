...
void ButtonsListCtrl::SetSelection(int sel)
{
    ...
    wxColour selected_btn_bg("#D66C47");    // Gradient #D66C47
    ...
    StateColor bg_color = StateColor(
        std::pair{wxColour(214, 108, 71), (int) StateColor::Hovered},
        std::pair{wxColour(214,108,71), (int) StateColor::Normal});
    m_pageButtons[m_selection]->SetBackgroundColor(bg_color);
