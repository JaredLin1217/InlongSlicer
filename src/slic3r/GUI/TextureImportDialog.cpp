...
void AccentSlider::OnPaint(wxPaintEvent&)
{
    ...
    wxColour accent_clr = StateColor::darkModeColorFor(IsEnabled() ? wxColour("#D66C47") : wxColour("#ACACAC"));
...
public:
        ...
        , m_display_numbers(std::move(display_numbers))
    {
        ...
        const wxColour action_clr = StateColor::darkModeColorFor(wxColour("#D66C47"));
...
private:
    ...
    wxPanel* create_item_row(wxWindow* parent, TextureAutoMixMode mode, int row_h)
    {
        ...
        wxColour accent   = StateColor::darkModeColorFor(wxColour("#D66C47"));
...
void TextureImportDialog::build_params_panel(wxWindow* parent, wxSizer* sizer)
{
...

    {
        StateColor preset_bg(
            std::pair<wxColour, int>(wxColour(185, 87, 58), StateColor::Pressed | StateColor::Checked),
            std::pair<wxColour, int>(wxColour(225, 130, 99), StateColor::Hovered | StateColor::Checked),
            std::pair<wxColour, int>(wxColour(214, 108, 71), StateColor::Checked),
...

    {
        StateColor btn_bg_white(
            ...
            std::pair<wxColour, int>(wxColour("#EEEEEE"), StateColor::Hovered),
            std::pair<wxColour, int>(*wxWHITE, StateColor::Normal));
        const wxColour btn_bd_accent = wxColour(214, 108, 71);
        const wxColour btn_text_accent = wxColour(214, 108, 71);
