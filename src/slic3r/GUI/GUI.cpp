...
{
	return
		wxString::Format(_L("The configuration may be generated by a newer version of %s."), wxString(SLIC3R_APP_FULL_NAME)) + " " +
...
void desktop_open_any_folder( const std::string& path )
{
    ...
    // Inlong#6449: Open containing dir instead of opening the file directly.
