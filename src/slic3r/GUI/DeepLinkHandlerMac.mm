...
@interface InlongDeepLinkHandler : NSObject
- (void)handleGetURLEvent:(NSAppleEventDescriptor *)event withReplyEvent:(NSAppleEventDescriptor *)reply;
@end

@implementation InlongDeepLinkHandler
- (void)handleGetURLEvent:(NSAppleEventDescriptor *)event withReplyEvent:(NSAppleEventDescriptor *)reply
{
...
{
    static InlongDeepLinkHandler *handler = nil;
    if (handler == nil)
        handler = [[InlongDeepLinkHandler alloc] init];
