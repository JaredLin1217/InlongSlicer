...
void BedShapePanel::build_panel(const Pointfs& default_pt, const std::string& custom_texture, const std::string& custom_model)
{
    ...
    // INLONG match style of wxStaticBox between platforms
    ...
    // INLONG replace wxChoicebook wxSimplebook and add a combo box for control
    ...
    line.widget = [this](wxWindow* parent) {
        ...
        filename_lbl->Bind(wxEVT_UPDATE_UI, ([this](wxUpdateUIEvent& e) {
                ...
                if (lbl != nullptr) {
                    ...
                    lbl->SetForegroundColour(exists ? wxGetApp().get_label_clr_default() : wxColour("#E14747")); // INLONG
