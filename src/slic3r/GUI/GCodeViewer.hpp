...
// INLONG: match right margin to the vertical slider window width to prevent overlap.
...
public:
    ...
    // INLONG: darken the layers not scrubbed to while using the preview layer slider
    ...
    // INLONG: brightness of those darkened layers, 1.0 = unchanged, 0.0 = black
