...
//
// It derives from InlongSlicer's own Slic3r::GUI::ProgressDialog (a real wxDialog
...
// recolorable wx surface, so it cannot follow InlongSlicer's (OS-independent) dark
