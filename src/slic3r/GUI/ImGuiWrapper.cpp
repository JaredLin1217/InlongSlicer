...
const ImVec4 ImGuiWrapper::COL_ORCA_DARK         = { 166 / 255.f, 78  / 255.f, 51 / 255.f, 1.f };
const ImVec4 ImGuiWrapper::COL_ORCA_HOVER        = { 225 / 255.f, 130 / 255.f, 99 / 255.f, 1.f };
const ImVec4 ImGuiWrapper::COL_ORCA_HOVER_DARK   = { 185 / 255.f, 87  / 255.f, 58 / 255.f, 1.f };
...
bool ImGuiWrapper::bbl_slider_float_style(const std::string &label, float *v, float v_min, float v_max, const char *format, float power, bool clamp, const wxString &tooltip)
{
    ...
    ImGui::PushStyleColor(ImGuiCol_SliderGrabActive, COL_INLONG);
...
bool ImGuiWrapper::bbl_checkbox(const wxString &label, bool &value)
{
    ...
    bool b_value = value;
    if (b_value) {
        ImGui::PushStyleColor(ImGuiCol_FrameBg, COL_INLONG);
        ImGui::PushStyleColor(ImGuiCol_FrameBgHovered, COL_ORCA_HOVER);
        ImGui::PushStyleColor(ImGuiCol_FrameBgActive, COL_INLONG);
    }
    auto label_utf8 = into_u8(label);
...
void ImGuiWrapper::push_menu_style(const float scale)
{
    if (m_is_dark_mode) {
        ...
        ImGui::PushStyleColor(ImGuiCol_Header, COL_ORCA_DARK);
        ImGui::PushStyleColor(ImGuiCol_HeaderHovered, COL_ORCA_HOVER_DARK);
        ImGui::PushStyleColor(ImGuiCol_HeaderActive, COL_ORCA_DARK);
    }
    else {
        ImGuiWrapper::push_toolbar_style(scale);
        ImGui::PushStyleVar(ImGuiStyleVar_WindowPadding, ImVec2(10.0f, 10.0f) * scale);
        ...
        ImGui::PushStyleColor(ImGuiCol_Header, COL_INLONG);
        ImGui::PushStyleColor(ImGuiCol_HeaderHovered, COL_ORCA_HOVER);
...
void ImGuiWrapper::push_common_window_style(const float scale) {
    if (m_is_dark_mode) {
        ...
        ImGui::PushStyleColor(ImGuiCol_Separator, ImGuiWrapper::COL_SEPARATOR_DARK);                             // 5
        ImGui::PushStyleColor(ImGuiCol_Button, ImVec4(1.00f, 1.00f, 1.00f, 1.00f));                              // 6
        ImGui::PushStyleColor(ImGuiCol_ButtonHovered, COL_ORCA_HOVER_DARK);                                      // 7
        ImGui::PushStyleColor(ImGuiCol_ButtonActive, COL_ORCA_DARK);                                             // 8
        ImGui::PushStyleColor(ImGuiCol_FrameBgHovered, ImVec4(84 / 255.0f, 84 / 255.0f, 90 / 255.0f, 1.00f));    // 9
        ImGui::PushStyleColor(ImGuiCol_FrameBgActive, ImVec4(62 / 255.0f, 62 / 255.0f, 69 / 255.0f, 1.00f));     // 10
        ImGui::PushStyleColor(ImGuiCol_FrameBg, ImVec4(238 / 255.0f, 238 / 255.0f, 238 / 255.0f, 0.00f));        // 11
        ...
        ImGui::PushStyleColor(ImGuiCol_PlotHistogram, COL_ORCA_DARK);                                            // 14
    }
    else {
        ImGui::PushStyleVar(ImGuiStyleVar_FrameBorderSize, 1.0f * scale);
        ImGui::PushStyleVar(ImGuiStyleVar_WindowPadding, ImVec2(20.0f, 10.0f) * scale);
        ...
        ImGui::PushStyleColor(ImGuiCol_Separator, ImGuiWrapper::COL_SEPARATOR);                                  // 5
        ImGui::PushStyleColor(ImGuiCol_Button, ImVec4(1.00f, 1.00f, 1.00f, 1.00f));                              // 6
        ImGui::PushStyleColor(ImGuiCol_ButtonHovered, COL_ORCA_HOVER);                                           // 7
        ImGui::PushStyleColor(ImGuiCol_ButtonActive, COL_INLONG);                                                // 8
        ...
        ImGui::PushStyleColor(ImGuiCol_PlotHistogram, COL_INLONG);                                               // 14
    }
}
...
void ImGuiWrapper::push_confirm_button_style() {
    if (m_is_dark_mode) {
        ImGui::PushStyleColor(ImGuiCol_Button, COL_ORCA_DARK);
        ImGui::PushStyleColor(ImGuiCol_Border, COL_ORCA_DARK);
        ImGui::PushStyleColor(ImGuiCol_ButtonHovered, COL_ORCA_HOVER_DARK);
        ImGui::PushStyleColor(ImGuiCol_ButtonActive, COL_ORCA_DARK);
        ...
        ImGui::PushStyleColor(ImGuiCol_Button, COL_INLONG);
        ImGui::PushStyleColor(ImGuiCol_Border, COL_INLONG);
        ImGui::PushStyleColor(ImGuiCol_ButtonHovered, COL_ORCA_HOVER);
        ImGui::PushStyleColor(ImGuiCol_ButtonActive, COL_INLONG);
...
void ImGuiWrapper::push_combo_style(const float scale)
{
    if (m_is_dark_mode) {
        ...
        ImGui::PushStyleVar(ImGuiStyleVar_FrameBorderSize, 1.0f * scale);
        ImGui::PushStyleColor(ImGuiCol_PopupBg, ImGuiWrapper::COL_WINDOW_BG_DARK);
        ImGui::PushStyleColor(ImGuiCol_BorderActive, {COL_ORCA_DARK.x, COL_ORCA_DARK.y, COL_ORCA_DARK.z, 0.6f});
        ImGui::PushStyleColor(ImGuiCol_HeaderHovered, {0.f, 0.f, 0.f, 0.f});                            // ORCA hovered item background color
        ImGui::PushStyleColor(ImGuiCol_HeaderActive, COL_ORCA_DARK);
        ImGui::PushStyleColor(ImGuiCol_Header, {COL_ORCA_DARK.x, COL_ORCA_DARK.y, COL_ORCA_DARK.z, 0.25f});
        ...
        ImGui::PushStyleVar(ImGuiStyleVar_FrameBorderSize, 1.0f * scale);
        ImGui::PushStyleColor(ImGuiCol_PopupBg, ImGuiWrapper::COL_WINDOW_BG);
        ImGui::PushStyleColor(ImGuiCol_BorderActive, {COL_INLONG.x, COL_INLONG.y, COL_INLONG.z, 0.6f});
        ImGui::PushStyleColor(ImGuiCol_HeaderHovered, {0.f, 0.f, 0.f, 0.f});                            // ORCA hovered item background color
        ImGui::PushStyleColor(ImGuiCol_HeaderActive, COL_ORCA);
        ImGui::PushStyleColor(ImGuiCol_Header, {COL_INLONG.x, COL_INLONG.y, COL_INLONG.z, 0.25f});
