    ...
    {{L("Quality"),
     ...
     {L("Strength"),
      {{"wall_loops", "", 1},
       ...
       {"surface_feature_enhance_mode", "", 1},
       {"top_feature_embed_layers", "", 1},
       {"bottom_feature_extend_layers", "", 1},
...
std::vector<SimpleSettingData> SettingsFactory::get_visible_options(const std::string& category, const bool is_part)
{
    ...
    t_config_option_keys object_options = {
        ...
        //support
        "support_top_z_distance", "support_base_pattern", "support_base_pattern_spacing", "support_interface_top_layers", "support_interface_bottom_layers", "support_interface_spacing", "support_bottom_interface_spacing",
        "support_top_contact_pattern", "support_top_contact_spacing", "support_bottom_contact_pattern", "support_bottom_contact_spacing", "support_object_xy_distance",
...
wxMenu* MenuFactory::append_submenu_add_handy_model(wxMenu* menu, ModelVolumeType type) {
    ...
    // Inlong: handy models shipped under <resources>/handy_models. Defining everything in one table
    ...
    static const std::vector<HandyModel> handy_models = {
        {L("Inlong Cube"),         {"InlongCube_v2.3mf"},                                     true},
        {L("InlongSliced Combo"),  {"OrcaSliced.3mf", "OrcaCube_v2.drc", "OrcaPlug_v2.drc"}, true},
        {L("Inlong Tolerance Test"), {"InlongToleranceTest.drc"}},
        ...
        {L("Inlong String Hell"),   {"Inlong_stringhell.drc"},                                 false, true},
    };
