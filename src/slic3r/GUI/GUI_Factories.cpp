...
wxMenu* MenuFactory::append_submenu_add_handy_model(wxMenu* menu, ModelVolumeType type) {
    ...
    for (auto &item : {L("Inlong Cube"), L("Inlong Tolerance Test"), L("3DBenchy"), L("Cali Cat"), L("Autodesk FDM Test"),
                       L("Voron Cube"), L("Stanford Bunny"), L("Inlong String Hell") }) {
        append_menu_item(
            ...
            [type, item](wxCommandEvent&) {
                ...
                if (item == L("Inlong Cube"))
                    file_names = { "InlongCube_v2.3mf" };
                else if (item == L("Inlong Tolerance Test"))
                    file_names = { "InlongToleranceTest.drc" };
                ...
                else if (item == L("Inlong String Hell")) {
                    file_names   = { "Inlong_stringhell.drc" };
                    is_stringhell = true;
                } else
                    return;
