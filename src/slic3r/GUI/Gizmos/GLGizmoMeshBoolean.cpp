...
void GLGizmoMeshBoolean::on_render()
{
    ...
    ColorRGB tool_color = {214.0f / 255.0f, 108.0f / 255.0f, 71.0f / 255.0f};
...
void GLGizmoMeshBoolean::on_render_input_window(float x, float y, float bottom_limit)
{
    ...
    auto selectable = [](const std::string& label, bool selected, const ImVec2& size_arg) {
        ...
        if (selected || hovered) {
            ...
            ImGui::PushStyleColor(ImGuiCol_Button, { 214.0f / 255.0f, 108.0f / 255.0f, 71.0f / 255.0f, 1.0f });
            ImGui::PushStyleColor(ImGuiCol_ButtonActive, { 214.0f / 255.0f, 108.0f / 255.0f, 71.0f / 255.0f, 1.0f });
            ImGui::PushStyleColor(ImGuiCol_ButtonHovered, { 214.0f / 255.0f, 108.0f / 255.0f, 71.0f / 255.0f, 1.0f });
        }
        else {
            ImGui::PushStyleColor(ImGuiCol_ButtonActive, { 214.0f / 255.0f, 108.0f / 255.0f, 71.0f / 255.0f, 1.0f });
            ImGui::PushStyleColor(ImGuiCol_ButtonHovered, { 214.0f / 255.0f, 108.0f / 255.0f, 71.0f / 255.0f, 1.0f });
