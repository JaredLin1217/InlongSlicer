...
public:
	...
	// returns true if path to the InlongSlicer desktop file is stored in App Config and existence of desktop file.
	...
	// Creates Desktop files and icons for both InlongSlicer and GcodeViewer.
	// Stores paths into App Config.
	// Rewrites if files already existed.
	static void perform_desktop_integration();
	// Deletes Desktop files and icons for both InlongSlicer and GcodeViewer at paths stored in App Config.
