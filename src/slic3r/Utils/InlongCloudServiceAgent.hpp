...
namespace secret_constants {
    ...
    constexpr const char* USER_SECRET_FILENAME = "inlong_refresh_token.sec";
} // namespace secret_constants

// ============================================================================
// Sync Protocol Data Structures (per Inlong Cloud Sync Protocol Specification)
// ============================================================================
// Note: These may also be defined in the network integration layer - guards prevent redefinition

#ifndef INLONG_SYNC_STRUCTS_DEFINED
#define INLONG_SYNC_STRUCTS_DEFINED
...
#endif // INLONG_SYNC_STRUCTS_DEFINED

/**
 * InlongCloudServiceAgent - Native cloud service and authentication implementation for Inlong Cloud.
 *
 ...
 *
 * This class combines the native auth and cloud sync responsibilities.
 */
class InlongCloudServiceAgent : public ICloudServiceAgent {
public:
    // ========================================================================
    // Auth Session Types
    // ========================================================================
    struct SessionInfo {
        ...
        std::string user_id;
        // Inlong auth semantics: user_name is the unique Inlong Cloud username,
    ...
    explicit InlongCloudServiceAgent(std::string log_dir);
    ~InlongCloudServiceAgent() override;

    std::string get_id() const override { return INLONG_CLOUD_PROVIDER; }
    ...
    // ========================================================================
    // Inlong-Specific: Bundle Subscription
    // ========================================================================
    ...
    bool set_user_session(const std::string& token,
                          ...
                          bool persist = true);
    // Accepts either nested Inlong cloud / GoTrue session JSON or flat WebView token JSON.
...
#endif // __INLONG_CLOUD_SERVICE_AGENT_HPP__
