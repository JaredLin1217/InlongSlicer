#ifndef __INLONG_PRINTER_AGENT_HPP__
#define __INLONG_PRINTER_AGENT_HPP__
...
/**
 * InlongPrinterAgent - Stub implementation for printer operations.
 *
 * All printer-related operations are currently stubs that return success.
 * Actual printer connectivity requires the BBL SDK or future Inlong implementation.
 */
class InlongPrinterAgent : public IPrinterAgent {
public:
    explicit InlongPrinterAgent(std::string log_dir);
    ~InlongPrinterAgent() override;
...
#endif // __INLONG_PRINTER_AGENT_HPP__
