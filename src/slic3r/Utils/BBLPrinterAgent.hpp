...
public:
    ...
    std::string to_inlong_filament_id(const std::string& printer_filament_id) const override;
    std::string from_inlong_filament_id(const std::string& inlong_filament_id) const override;
    ...
    static std::string to_inlong_payload(std::string json_text);
    static std::string from_inlong_payload(std::string json_text);
