...
public:
     ...
     */
    virtual std::string to_inlong_filament_id(const std::string& printer_filament_id) const { return printer_filament_id; }
    virtual std::string from_inlong_filament_id(const std::string& inlong_filament_id) const { return inlong_filament_id; }
};
