    ...
    wxVector<wxInspector::PropertyDef>& props)
{
    ...
    props.push_back({"Button Style", "Inlong Button", PropertyType::Choice,
    ...
    props.push_back({"Button Type", "Inlong Button", PropertyType::Choice,
    ...
    props.push_back({"Selected", "Inlong Button", PropertyType::Boolean,
    ...
    wxVector<wxInspector::PropertyDef>& props)
{
    ...
    props.push_back({"Half Checked", "Inlong CheckBox", PropertyType::Boolean,
    ...
    wxVector<wxInspector::PropertyDef>& props)
{
    ...
    props.push_back({"Label", "Inlong TextInput", PropertyType::String,
        ti->GetLabel(), false, {},
        [ti]() { return ti->GetLabel(); },
        [ti](const wxString& v) { ti->SetLabel(v); return true; }});

    props.push_back({"Text Value", "Inlong TextInput", PropertyType::String,
        ti->GetTextCtrl()->GetValue(), false, {},
        [ti]() { return ti->GetTextCtrl()->GetValue(); },
        [ti](const wxString& v) { ti->GetTextCtrl()->SetValue(v); return true; }});

    props.push_back({"Corner Radius", "Inlong TextInput", PropertyType::Integer,
    ...
    wxVector<wxInspector::PropertyDef>& props)
{
    ...
    props.push_back({"Value", "Inlong SwitchButton", PropertyType::Boolean,
    ...
    wxVector<wxInspector::PropertyDef>& props)
{
    ...
    props.push_back({"Proportion", "Inlong ProgressBar", PropertyType::String,
    ...
    props.push_back({"Show Number", "Inlong ProgressBar", PropertyType::Boolean,
    ...
    wxVector<wxInspector::PropertyDef>& props)
{
    ...
    props.push_back({"Is Hyperlink", "Inlong Label", PropertyType::Boolean,
    ...
    props.push_back({"Font Point Size", "Inlong Label", PropertyType::ReadOnly,
