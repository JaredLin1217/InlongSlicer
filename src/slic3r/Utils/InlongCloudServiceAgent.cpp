...
bool InlongCloudServiceAgent::refresh_now(const std::string& refresh_token, const std::string& reason, bool async)
{
...
bool InlongCloudServiceAgent::refresh_from_storage(const std::string& reason, bool async)
{
...
bool InlongCloudServiceAgent::refresh_session_with_token(const std::string& refresh_token)
{
    ...
    // This makes InlongCloudServiceAgent self-contained without requiring external setup
    try {
...
bool InlongCloudServiceAgent::attempt_refresh_after_unauthorized(const std::string& reason)
{
    if (refresh_from_storage(reason, false)) return true;
