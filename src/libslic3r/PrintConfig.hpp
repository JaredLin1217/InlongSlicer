...
// Inlong: print order of surface fill loops/fragments for center-based fill patterns
...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionBool,                raft_generate_bounding_box))
    ((ConfigOptionBool,                raft_ignore_internal_contours))
    ...
    ((ConfigOptionFloat,               support_top_contact_spacing))
    ((ConfigOptionFloat,               support_bottom_contact_spacing))
    ...
    ((ConfigOptionEnum<SupportMaterialInterfacePattern>, support_top_contact_pattern))
    ((ConfigOptionEnum<SupportMaterialInterfacePattern>, support_bottom_contact_pattern))
...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionBool,                 relative_bridge_angle)) // INLONG: Relative bridge angle flag
    ...
    ((ConfigOptionBool,                 surface_feature_enhance_mode))
    ((ConfigOptionInt,                  top_feature_embed_layers))
    ((ConfigOptionInt,                  bottom_feature_extend_layers))
