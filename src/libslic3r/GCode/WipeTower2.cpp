...
WipeTower2::WipeTowerInfo::ToolChange WipeTower2::set_toolchange(size_t old_tool, size_t new_tool, float layer_height, float wipe_volume, bool first_layer_plan)
{
    ...
    // m_extra_spacing_wipe * m_perimeter_width. Use the same spacing here so
    // reserved depth matches consumed depth and first-layer purge segments do not leave visible gaps.
        ...
        const std::vector<WipeTowerInfo::ToolChange>& tool_changes) const
{
    ...
    // finish-layer saving and the minimal-purge clamp still apply to it (Inlong depth
