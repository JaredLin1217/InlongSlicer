...
// INLONG: Add Pressure Advance visualization support
    ...
    public:
        ...
        // Inlong: if true, only change new layer if ETags::Layer_Change occurs
...
// INLONG: Add Pressure Advance visualization support
        ...
        // Do NOT add an extruder_id parameter ??InlongSlicer does not use BambuStudio's
