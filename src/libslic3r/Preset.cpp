...
std::string generate_preset_setting_id(const std::string& vendor, const std::string& type, const std::string& name)
{
    ...
    // namespace (InlongCloudServiceAgent). Keep in sync with scripts/assign_vendor_setting_ids.py;
...
static std::vector<std::string> s_Preset_print_options{
    ...
    "surface_feature_enhance_mode",
    "top_feature_embed_layers",
    "bottom_feature_extend_layers",
    ...
    "enable_warp_prevention", "warp_prevention_level", "warp_prevention_thermal_resolution", "warp_prevention_max_slowdown", "warp_prevention_min_wall_speed",
    "warp_prevention_min_bottom_speed", "warp_prevention_early_layers",
    "warp_prevention_adjust_acceleration", "warp_prevention_max_accel_reduction", "warp_prevention_min_wall_acceleration",
    ...
    "support_top_contact_pattern",
    "support_top_contact_spacing",
    "support_bottom_contact_pattern",
    "support_bottom_contact_spacing",
...
void PresetCollection::update_library_profile_excluded_from()
{
    ...
    // Check all presets that have the same alias as filament presets with empty compatible_printers in Inlong Filament Library.
