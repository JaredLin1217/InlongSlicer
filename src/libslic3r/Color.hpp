...
public:
    ...
    static const ColorRGB ORCA()		{ return {214.0f / 255.0f, 108.0f / 255.0f, 71.0f / 255.0f}; }
...
public:
    ...
    static const ColorRGBA ORCA()        { return {214.0f / 255.0f, 108.0f / 255.0f, 71.0f / 255.0f, 1.0f}; }
