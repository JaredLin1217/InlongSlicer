...
// INLONG: post processor below used for Dynamic Pressure advance
...
private:
    ...
    // Inlong: pass the complete collection of region perimeters to the extrude loop to check whether the wipe before external loop
    ...
    // Inlong: Adaptive PA code segment end
    ...
    // INLONG: Add support for role based fan speed control
...
#if !defined(NDEBUG)
#define INLONG_CHECK_GCODE_PLACEHOLDERS 1
#endif
